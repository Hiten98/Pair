  ...
  render() {
    ...
    return (
      <div>
        ...
        <Switch>
          <Route path="/register/intern/edit-profile/user-details" render={() => <UserDetailsForm {...toPass} />} />
          <Route path="/register/intern/edit-profile/roommate" render={() => <RoommatePreferencesForm {...toPass} />} />
          <Route path="/register/intern/edit-profile/housing" render={() => <HousingPreferencesForm {...toPass} />} />
